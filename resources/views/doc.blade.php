    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-8 mx-auto">
                ...
                <p>
                    Im <a href="http://erzählkreis.de">Erzählkreis</a> kannst du gemeinsam mit deinen Freunden interaktive Geschichten schreiben. Fertige Geschichten kannst du auf unserer Website oder über unseren <a href="https://skills-store.amazon.de/deeplink/dp/B07BKR4J8F?deviceType=app&share&refSuffix=ss_copy">Alexa Skill</a> spielen.
                </p>
                <p>
                    Was unterscheidet eigentlich <em>interaktive</em> Geschichten von normalen Geschichten? Interaktive Geschichten sind nicht linear, d.h. sie haben nicht einen einzelnen Handlungsstrang, sondern können sich verzweigen und vielleicht sogar unterschiedliche Enden haben. Diese Art von Geschichten nennt man im Englischen <a href="https://de.wikipedia.org/wiki/Interactive_Fiction">Interactive Fiction</a>, oder - wenn das Spielen und weniger die Handlung im Fordergrund steht - <a href="https://de.wikipedia.org/wiki/Adventure">Text Adventures</a>.
                </p>
                <p>
